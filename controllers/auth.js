...
const calculateRank = (entries) => {
    if (entries >= 500) {
        return { rank: 6, title: "Grandmaster", discount: 90 };
    }
    if (entries >= 100) {
        return { rank: 5, title: "Legend", discount: 50 };
    }
    if (entries >= 25) {
        return { rank: 4, title: "Diamond", discount: 25 };
    }
    if (entries >= 10) {
        return { rank: 3, title: "Gold", discount: 10 };
    }
    if (entries >= 5) {
        return { rank: 2, title: "Silver", discount: 5 };
    }
    if (entries >= 1) {
        return { rank: 1, title: "Bronze", discount: 0 };
    }
